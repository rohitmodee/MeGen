...
from molgym.reward import SolvationReward, CustomReward
...
# sys.path.insert(1, '/home2/akansha20aug/gagen/examples/molgym_moified_add_one_atom')
# sys.path[-1] = '/home2/akansha20aug/gagen/examples/molgym_moified_add_one_atom'
# del sys.path[-1]
...
def main() -> None:
    ...
    if config['initial_structure']:
        initial_structure = ase.io.read(config['initial_structure'], index=":", format='xyz')
    else:
